...
static lv_display_t *bsp_display_lcd_init()
{
    ...
    bsp_io_expander_init();
    BSP_ERROR_CHECK_RETURN_ERR(esp_io_expander_set_dir(io_expander, BSP_LCD_RST | BSP_LCD_TOUCH_RST, IO_EXPANDER_OUTPUT));
    BSP_ERROR_CHECK_RETURN_ERR(esp_io_expander_set_level(io_expander, BSP_LCD_RST | BSP_LCD_TOUCH_RST, false));
    vTaskDelay(pdMS_TO_TICKS(200));
    BSP_ERROR_CHECK_RETURN_ERR(esp_io_expander_set_level(io_expander, BSP_LCD_RST | BSP_LCD_TOUCH_RST, true));
