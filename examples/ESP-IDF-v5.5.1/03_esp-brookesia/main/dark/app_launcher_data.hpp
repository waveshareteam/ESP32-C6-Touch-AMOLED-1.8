...
constexpr AppLauncherIcon::Data STYLESHEET_368_448_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
...
constexpr AppLauncherData STYLESHEET_368_448_DARK_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
    ...
    .icon = STYLESHEET_368_448_DARK_APP_LAUNCHER_ICON_DATA,
    .flags = {
