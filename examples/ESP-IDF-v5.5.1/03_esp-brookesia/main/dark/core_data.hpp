...
constexpr uint32_t STYLESHEET_368_448_DARK_CORE_DISPLAY_BG_COLOR = 0x1A1A1A;

constexpr base::Display::Data STYLESHEET_368_448_DARK_CORE_DISPLAY_DATA = {
    .background = {
        .color = gui::StyleColor::COLOR(STYLESHEET_368_448_DARK_CORE_DISPLAY_BG_COLOR),
...
constexpr base::Manager::Data STYLESHEET_368_448_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 3,
    },
    .flags = {
...
constexpr const char *STYLESHEET_368_448_DARK_CORE_INFO_DATA_NAME = "Default Dark";

constexpr base::Context::Data STYLESHEET_368_448_DARK_CORE_DATA = {
    .name = STYLESHEET_368_448_DARK_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT(368, 448),
    .display = STYLESHEET_368_448_DARK_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_368_448_DARK_CORE_MANAGER_DATA,
};
