...
void my_touchpad_read(lv_indev_drv_t *indev_driver, lv_indev_data_t *data) {
  int32_t touchX = CST820->IIC_Read_Device_Value(CST820->Arduino_IIC_Touch::Value_Information::TOUCH_COORDINATE_X);
  int32_t touchY = CST820->IIC_Read_Device_Value(CST820->Arduino_IIC_Touch::Value_Information::TOUCH_COORDINATE_Y);
