...
constexpr StatusBar::AreaData STYLESHEET_368_448_DARK_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_368_448_DARK_STATUS_BAR_DATA = {
    .main = {
    ...
    .area = {
        .num = 3,
        .data = {
            STYLESHEET_368_448_DARK_STATUS_BAR_AREA_DATA(30, StatusBar::AreaAlign::START),
            STYLESHEET_368_448_DARK_STATUS_BAR_AREA_DATA(40, StatusBar::AreaAlign::CENTER),
            STYLESHEET_368_448_DARK_STATUS_BAR_AREA_DATA(30, StatusBar::AreaAlign::END),
        },
    },
